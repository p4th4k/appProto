...
2. Have three checks to make sure the whole packet is delivered. We extract
   ...
   - Content encoding
    ...
    After that we extract data from the body content
    
    |
Write:
1. create_response: creates and sends the response
2. _create_response_json_content: Based on the request performs search in dict
3. _create_message: create the final message
4. _write: Send the message
'''